...
enum operation {
	O_PRINTI, O_PRINTF, O_PRINTSTR, O_PRINTLN, O_PRINTSPC,
	O_READI, O_READF,
	O_ITOF,
	O_LABEL, O_GOTO, O_GOTOT, O_GOTOF,
	O_ALLOC,
	O_ASIGN,
	O_ADDI, O_ADDF,
	O_SUBI, O_SUBF,
	...
	O_POWII, O_POWIF,
	O_TRUE, O_FALSE,
	O_EQI, O_NEQI, O_LTI, O_LTEI, O_GTI, O_GTEI,
	O_EQF, O_NEQF, O_LTF, O_LTEF, O_GTF, O_GTEF,
	O_AND, O_OR, O_XOR, O_NOT,
	O_PARAM, O_CALL, O_CALLVAL, O_RETN, O_RVAL, O_FUNC,
	O_DEREF, O_STORE,
	O_ARRCPY, O_ARRLEN,
};
...
static char print_op[53][14] = {
	...
	"read_i", "read_f",
	"itof",
	"label", "goto", "goto_if_true",  "goto_if_false",
	"alloc",
	"let",
	"add_i", "add_f", "sub_i", "sub_f", "mul_i", "mul_f", "div_i", "div_f", "mod", "pow_ii", "pow_if",
	"true", "false",
	"==i", "!=i", "<i", "<=i", ">i", ">=i",
	"==f", "!=f", "<f", "<=f", ">f", ">=f",
	"and", "or", "xor", "not",
